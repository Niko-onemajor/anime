  ...
  <div class="search-overlay" v-if="showSearchModal" @click.self="showSearchModal = false">
    <div class="search-modal">
      <div class="search-modal-header">
        ...
        <input ref="searchInputRef" v-model="userSearchKeyword" class="search-modal-input" placeholder="搜索用户..." @input="onSearchInput" @keydown.esc="showSearchModal = false" />
      ...
      <div class="search-modal-body">
        ...
        <div v-else-if="searchResults.length === 0 && userSearchKeyword.trim()" class="search-empty">未找到相关用户</div>
        <div v-else-if="searchResults.length === 0 && !userSearchKeyword.trim()" class="search-hint">输入用户名开始搜索</div>
        <div v-else class="search-results">
          <div v-for="user in searchResults" :key="user.id" class="search-result-item" @click="goToUserHomeFromSearch(user.username)">
